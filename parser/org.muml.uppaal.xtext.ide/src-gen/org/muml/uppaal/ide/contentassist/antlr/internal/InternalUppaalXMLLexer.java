package org.muml.uppaal.ide.contentassist.antlr.internal;
...
public class InternalUppaalXMLLexer extends Lexer {
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25241:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalUppaalXML.g:25241:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalUppaalXML.g:25241:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalUppaalXML.g:25241:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalUppaalXML.g:25241:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop1:
                    do {
                        int alt1=3;
                    ...
                    break;
                case 2 :
                    // InternalUppaalXML.g:25241:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalUppaalXML.g:25241:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop2:
                    do {
                        int alt2=3;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25243:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalUppaalXML.g:25243:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalUppaalXML.g:25243:35: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25245:10: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // InternalUppaalXML.g:25245:12: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // InternalUppaalXML.g:25245:12: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalUppaalXML.g:25245:13: '0'
                    {
                    match('0'); 
                    ...
                    break;
                case 2 :
                    // InternalUppaalXML.g:25245:17: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // InternalUppaalXML.g:25245:26: ( '0' .. '9' )*
                    loop5:
                    do {
                        int alt5=2;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalUppaalXML.g:25245:27: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_SINGLE_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25247:26: ( '//' (~ ( ( '<' | '\\r' | '\\n' ) ) )* )
            // InternalUppaalXML.g:25247:28: '//' (~ ( ( '<' | '\\r' | '\\n' ) ) )*
            {
            match("//"); 

            // InternalUppaalXML.g:25247:33: (~ ( ( '<' | '\\r' | '\\n' ) ) )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_MULTI_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25249:25: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalUppaalXML.g:25249:27: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalUppaalXML.g:25249:32: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25251:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalUppaalXML.g:25251:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalUppaalXML.g:25251:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalUppaalXML.g:25253:16: ( . )
            // InternalUppaalXML.g:25253:18: .
            {
            matchAny(); 
